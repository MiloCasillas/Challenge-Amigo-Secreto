...
ingresar nombres de amigos en una lista para luego realizar un sorteo aleatorio 
...
la página, y al finalizar, un botón "Sortear Amigo" seleccionará uno de 
los nombres de forma aleatoria, mostrando el resultado en pantalla.
